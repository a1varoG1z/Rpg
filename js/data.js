...
addFamily('nahual', 2, 'tierra', 'brujo', 'debilitar', ['Aprendiz de Nahual', 'Nahual Cambiapieles', 'Gran Brujo Nahual'], ['Puede transformarse en la bestia que más tema su enemigo.', 'Cada combate le enseña una nueva forma que dominar.', 'Ya no hay bestia en Texel cuya piel no pueda vestir a voluntad.']);
addFamily('quetzalcoatl', 3, 'viento', 'guru', 'bendicion', ['Serpiente Emplumada Joven', 'Quetzalcóatl Ascendente', 'Quetzalcóatl, Señor del Viento'], ['Serpiente y ave a la vez, trajo el conocimiento a su pueblo.', 'Su vuelo entre las nubes reparte tanto sabiduría como tormentas.', 'El propio viento de Texel obedece el batir de sus plumas.']);
addFamily('cadejo', 1, 'tierra', 'picaro', 'aturdir', ['Cadejo Blanco', 'Cadejo Guardián', 'Cadejo Protector de Caminantes'], ['Aparece en los caminos de noche para proteger — o asustar — a quien los recorre.', 'Camina toda la noche junto a los viajeros sin que ninguno note su presencia.', 'Ningún caminante que reza su nombre se pierde jamás en la oscuridad.']);
addFamily('hada', 1, 'viento', 'guru', 'curar', ['Hada Menor', 'Hada del Bosque', 'Reina de las Hadas'], ['Su polvo brillante puede curar heridas o gastar una broma, según su humor.', 'Su polvo dorado convierte cualquier claro del bosque en su propio reino.', 'Todas las hadas del bosque responden a su llamada.']);
...
addFamily('zeus', 3, 'rayo', 'campeon', 'grito', ['Joven del Olimpo', 'Heredero del Rayo', 'Zeus, Señor del Trueno'], ['Ningún cielo se atreve a nublarse sin su permiso.', 'Cada rayo que lanza deja claro de quién es el cielo.', 'El Olimpo entero calla cuando él decide hablar con el trueno.']);
addFamily('guerreromedieval', 1, 'tierra', 'campeon', 'golpe', ['Recluta de Armadura', 'Caballero de Armas', 'Comandante de la Guardia'], ['Entrenado desde niño para defender su reino con espada y escudo.', 'Ha subido de rango tras defender la muralla en incontables asedios.', 'Comanda a toda la guardia del reino con la misma disciplina que lo formó a él.']);
addFamily('valquiria', 2, 'rayo', 'campeon', 'grito', ['Escudera Valquiria', 'Valquiria de Combate', 'Elegidora de los Caídos'], ['Decide quién de los caídos en batalla merece cabalgar hasta el Valhalla.', 'Ha cabalgado sobre incontables campos de batalla en busca de los caídos más dignos.', 'Su juicio decide quién cruza las puertas del Valhalla y quién se queda atrás.']);
addFamily('golem', 2, 'tierra', 'campeon', 'escudo', ['Golem de Barro', 'Golem de Piedra', 'Golem de Hierro Ancestral'], ['Animado por magia antigua, no conoce el cansancio ni el miedo.', 'La piedra que lo forma se ha endurecido tras incontables golpes.', 'El hierro ancestral que lo recorre ya no conoce la palabra derrota.']);
addFamily('satiromusico', 2, 'viento', 'guru', 'bendicion', ['Sátiro Flautista', 'Sátiro de la Fiesta Eterna', 'Sumo Sátiro de Dioniso'], ['Su flauta pone a bailar hasta al enemigo más serio.', 'Su melodía ya no distingue entre aliados y enemigos: todos terminan bailando.', 'El mismísimo Dioniso reconoce en él a su discípulo favorito.']);
...
addFamily('pazuzu', 3, 'viento', 'brujo', 'debilitar', ['Espíritu Menor del Viento', 'Heraldo de Pazuzu', 'Pazuzu, Señor de los Vientos del Sur'], ['Rey de los demonios del viento, tan temido como respetado.', 'Su heraldo recorre el desierto anunciando tormentas de arena a su paso.', 'Ni el viento del sur se atreve a soplar sin su permiso.']);
addFamily('garuda', 2, 'viento', 'explorador', 'furia', ['Polluelo de Garuda', 'Garuda Cazadora', 'Garuda, Montura de los Dioses'], ['Ave gigante capaz de cargar a un dios entero sobre su lomo.', 'Caza presas cada vez más grandes con garras cada vez más firmes.', 'Los propios dioses eligen montarla para cruzar el cielo.']);
addFamily('anubis', 3, 'tierra', 'brujo', 'debilitar', ['Chacal del Desierto', 'Sacerdote de Anubis', 'Anubis, Guardián de los Muertos'], ['Pesa el corazón de cada alma antes de dejarla pasar al más allá.', 'Cada alma que pesa en su balanza aprende a temer su juicio.', 'Ningún muerto de Texel cruza al más allá sin pasar antes por él.']);
addFamily('ra', 3, 'fuego', 'guru', 'arrasar', ['Disco Solar Joven', 'Heraldo de Ra', 'Ra, Señor del Sol'], ['Su carro cruza el cielo cada día, y con él, la luz del mundo.', 'Su heraldo recorre el cielo anunciando el amanecer cada mañana.', 'Sin su carro cruzando el cielo, ningún día en Texel volvería a amanecer.']);
...
addFamily('hombretigre', 2, 'tierra', 'picaro', 'furia', ['Cachorro Tigre', 'Guerrero Tigre', 'Señor de las Rayas Doradas'], ['Ataca en silencio y golpea con la fuerza de un tigre de bengala.', 'Sus rayas doradas ya son sinónimo de un ataque certero y silencioso.', 'Nadie ve venir al Señor de las Rayas Doradas hasta que ya es tarde.']);
addFamily('hombrelobo', 2, 'viento', 'picaro', 'furia', ['Joven Maldito', 'Hombre Lobo', 'Alfa de la Luna Llena'], ['Cada luna llena pierde el control... y gana una fuerza brutal.', 'Cada luna llena le arrebata más control... y le entrega más fuerza.', 'Como alfa, ya no necesita esperar a la luna llena para desatar su furia.']);
addFamily('dracula', 3, 'rayo', 'brujo', 'drenar', ['Vástago de la Noche', 'Noble de Sangre Oscura', 'Drácula, Señor de la Noche'], ['Ha sobrevivido siglos alimentándose de las sombras de Texel.', 'Cada noble que se cruza en su camino termina siendo parte de su corte de sombras.', 'Ningún amanecer en Texel se atreve a alcanzarlo antes de que regrese a su castillo.']);
addFamily('genbu', 2, 'agua', 'campeon', 'escudo', ['Tortuga Joven de Genbu', 'Genbu, Guardián del Norte', 'Genbu, Escudo de las Profundidades'], ['Su caparazón ha resistido más golpes de los que nadie puede contar.', 'Guarda el norte con la paciencia de quien lleva siglos sin ceder terreno.', 'Su caparazón se ha convertido en el escudo más profundo de todo Texel.']);
addFamily('escualo', 1, 'agua', 'picaro', 'furia', ['Aprendiz Tiburón', 'Escualo de Combate', 'Depredador de los Siete Mares'], ['Huele la sangre — y la debilidad — antes que nadie.', 'Cada combate afila más sus instintos de depredador.', 'Los siete mares le pertenecen: nada débil sobrevive donde él caza.']);
addFamily('hercules', 3, 'tierra', 'campeon', 'golpe', ['Joven de Fuerza Divina', 'Hércules en sus Trabajos', 'Hércules, el Semidiós'], ['Ha completado hazañas que ningún mortal lograría siquiera empezar.', 'Cada trabajo imposible que completa añade una hazaña más a su leyenda.', 'Su fuerza ya no se mide como la de un mortal, sino como la de un dios.']);
addFamily('ciclope', 2, 'tierra', 'campeon', 'golpe', ['Cíclope Pastor', 'Cíclope Forjador', 'Cíclope, Ojo del Trueno'], ['Con un solo ojo ve más peligro que la mayoría con dos.', 'Su forja produce armas capaces de atravesar la piedra más dura de la montaña.', 'Su único ojo ve venir la tormenta antes de que el propio cielo se oscurezca.']);
addFamily('driada', 1, 'tierra', 'guru', 'curar', ['Brote de Dríada', 'Dríada del Bosque', 'Dríada Madre del Bosque Ancestral'], ['Su vida está ligada al árbol que la vio nacer.', 'Su raíz se extiende cada vez más profunda en el corazón del bosque.', 'Es la madre de todos los árboles del bosque ancestral, y ellos la protegen a su vez.']);
addFamily('ent', 2, 'tierra', 'campeon', 'escudo', ['Retoño Andante', 'Ent Guardián', 'Ent Ancestral del Bosque Viejo'], ['Piensa despacio, pero cuando decide actuar, nada lo detiene.', 'Cada año que pasa, sus raíces se hunden un poco más en la tierra vieja.', 'El bosque viejo entero escucha su voz cuando por fin decide hablar.']);
addFamily('hidraserpiente', 2, 'agua', 'brujo', 'arrasar', ['Hidra Recién Nacida', 'Hidra de Pantano', 'Hidra de las Nueve Cabezas'], ['Corta una cabeza y otras dos crecerán en su lugar.', 'Cada cabeza cortada solo alimenta más su furia — y su número.', 'Nueve cabezas vigilan el pantano: ninguna presa escapa a todas a la vez.']);
addFamily('hombreoso', 1, 'tierra', 'campeon', 'golpe', ['Joven Oso', 'Guerrero Oso', 'Gran Oso de las Montañas'], ['Su abrazo es tan mortal como su zarpazo.', 'Su fuerza ha crecido tanto como su territorio en las montañas.', 'Ningún rival sobrevive a un abrazo del Gran Oso de las Montañas.']);
addFamily('mujercisne', 2, 'agua', 'guru', 'bendicion', ['Doncella Cisne', 'Mujer Cisne', 'Reina de los Lagos Blancos'], ['Su plumaje esconde una gracia que desarma a cualquier rival.', 'Su gracia en el combate desarma a quien la subestima por su belleza.', 'Gobierna los lagos blancos con la misma elegancia con la que vuela.']);
...
addFamily('esfinge', 3, 'tierra', 'guru', 'debilitar', ['Cachorra de Esfinge', 'Esfinge Guardiana', 'Esfinge, Guardiana de Enigmas'], ['Solo deja pasar a quien resuelve su acertijo — a los demás, se los come.', 'Cada acertijo que plantea es más difícil — y más mortal — que el anterior.', 'Solo los más sabios de Texel se atreven a intentar cruzar ante ella.']);
addFamily('grifo', 2, 'viento', 'explorador', 'furia', ['Polluelo de Grifo', 'Grifo Cazador', 'Grifo, Rey de las Alturas'], ['Mitad águila, mitad león, caza tanto en tierra como en el aire.', 'Caza con la misma facilidad en tierra que en el aire, sin dar tregua a su presa.', 'Es el rey indiscutido de las alturas, y ningún ave se atreve a desafiarlo.']);
addFamily('lamasu', 2, 'tierra', 'campeon', 'escudo', ['Guardián Menor Lamasu', 'Lamasu de las Puertas', 'Lamasu, Custodio de Palacios'], ['Vigila las puertas de los palacios antiguos con cuerpo de toro y alas de águila.', 'Vigila cada entrada del palacio sin perder jamás la concentración.', 'Ningún intruso ha logrado cruzar las puertas que él custodia.']);
addFamily('pegaso', 2, 'viento', 'explorador', 'furia', ['Potrillo Alado', 'Pegaso Veloz', 'Pegaso, Corcel de las Nubes'], ['Ningún jinete olvida jamás la primera vez que voló sobre sus alas.', 'Su velocidad en el aire ya deja atrás a cualquier otra criatura alada.', 'Cabalgar sobre él es cabalgar entre las nubes mismas.']);
addFamily('silfide', 1, 'viento', 'guru', 'bendicion', ['Brisa Menor', 'Sílfide del Viento', 'Sílfide, Espíritu del Aire Puro'], ['Tan ligera que apenas roza el suelo al caminar.', 'El viento la lleva cada vez más lejos, casi sin tocar el suelo.', 'Es pura esencia del aire: nadie ha logrado verla completamente quieta.']);
addFamily('wyvern', 2, 'viento', 'picaro', 'furia', ['Cría de Wyvern', 'Wyvern Cazador', 'Wyvern, Terror de los Cielos'], ['Más ágil que un dragón, y su aguijón es igual de letal.', 'Su aguijón se ha vuelto tan letal como sus garras.', 'Es el terror indiscutido de los cielos: ni los dragones se atreven a cruzarse en su camino.']);
addFamily('cecaelia', 2, 'agua', 'brujo', 'debilitar', ['Joven Cecaelia', 'Cecaelia de los Arrecifes', 'Cecaelia, Bruja del Coral'], ['Mitad mujer, mitad pulpo, teje hechizos tan enredados como sus tentáculos.', 'Sus hechizos se enredan tanto como sus propios tentáculos entre el coral.', 'Ninguna bruja del arrecife teje magia tan retorcida como ella.']);
addFamily('hipocampo', 1, 'agua', 'explorador', 'debilitar', ['Hipocampo Joven', 'Hipocampo de las Corrientes', 'Hipocampo, Corcel del Mar'], ['Mitad caballo, mitad pez, tira de los carros de los dioses del mar.', 'Tira de carros cada vez más pesados entre las corrientes marinas.', 'Es el corcel elegido de los dioses del mar para cruzar cualquier tormenta.']);
addFamily('enano', 1, 'tierra', 'campeon', 'golpe', ['Enano Aprendiz', 'Enano Herrero', 'Enano Rey de la Montaña'], ['Forja armas capaces de atravesar la piedra más dura.', 'Cada arma que forja es más resistente que la anterior.', 'Su yunque ha forjado las armas que defienden la montaña entera.']);
addFamily('duendetravieso', 1, 'viento', 'picaro', 'aturdir', ['Duende Travieso', 'Duende Embaucador', 'Duende Rey de las Bromas'], ['Le encanta más gastar una broma que ganar una pelea.', 'Cada broma que gasta es más elaborada — y más difícil de evitar.', 'Es el rey indiscutido de las bromas, temido y adorado a partes iguales.']);
addFamily('guerreroleopardo', 2, 'tierra', 'picaro', 'furia', ['Joven Leopardo', 'Guerrero Leopardo', 'Señor de las Manchas Doradas'], ['Ataca desde las sombras y desaparece antes de que puedan responder.', 'Sus manchas doradas ya son sinónimo de un ataque que nadie ve venir.', 'Nadie sobrevive a un encuentro con el Señor de las Manchas Doradas.']);
addFamily('panteranegra', 2, 'tierra', 'picaro', 'aturdir', ['Cachorro de Pantera', 'Guerrero Pantera Negra', 'Rey de la Pantera Negra'], ['Se mueve en total silencio hasta que ya es demasiado tarde para su presa.', 'Su sigilo ya es legendario entre quienes han sobrevivido para contarlo.', 'Es el rey indiscutido de las sombras: nadie lo ve llegar.']);
addFamily('armaduratecno', 3, 'rayo', 'explorador', 'golpe', ['Prototipo de Armadura', 'Piloto de Armadura de Combate', 'Titán de Acero y Rayo'], ['Su armadura convierte a un simple mortal en una máquina de guerra.', 'Cada batalla perfecciona un poco más el ajuste entre su armadura y su cuerpo.', 'Ya no hay distinción entre el piloto y la máquina: son un único titán.']);
...
addFamily('amazona', 2, 'viento', 'picaro', 'furia', ['Joven Amazona', 'Guerrera Amazona', 'Reina de las Amazonas'], ['Entrenada desde niña para no depender de nadie en la batalla.', 'Ha luchado en más batallas de las que puede contar sin perder ni una.', 'Gobierna a las Amazonas con la misma independencia que le enseñaron de niña.']);
addFamily('bigfoot', 1, 'tierra', 'campeon', 'golpe', ['Rastro en el Bosque', 'Bigfoot Solitario', 'Bigfoot, Leyenda del Bosque'], ['Pocos lo han visto, y menos aún han vivido para contarlo con detalle.', 'Cada avistamiento añade un capítulo más a su leyenda del bosque.', 'Es ya más mito que criatura, pero el bosque entero sabe que es real.']);
addFamily('nessie', 2, 'agua', 'campeon', 'escudo', ['Cría del Lago', 'Monstruo del Lago', 'Nessie, Leyenda de las Aguas Frías'], ['Ha esquivado a cazadores y curiosos durante siglos sin ser jamás atrapada.', 'Ha aprendido a esconderse de cazadores cada vez más decididos a encontrarla.', 'Su leyenda ha sobrevivido a siglos de curiosos sin que nadie logre atraparla.']);
addFamily('samurai', 2, 'rayo', 'picaro', 'furia', ['Aprendiz de Samurái', 'Samurái Errante', 'Maestro Espadachín del Trueno'], ['Su espada se mueve más rápido de lo que el ojo puede seguir.', 'Su espada se ha movido en tantos duelos que ya no necesita pensar antes de golpear.', 'Su corte es tan rápido como el propio trueno que lleva por nombre.']);
addFamily('hombrefuego', 1, 'fuego', 'brujo', 'debilitar', ['Chispa Viviente', 'Hombre de Fuego', 'Avatar de las Llamas'], ['Cada paso que da deja un rastro de brasas ardientes.', 'Las brasas que deja a su paso ya arden más tiempo que antes.', 'Es la llama misma hecha carne: nada que toca vuelve a ser lo mismo.']);
addFamily('sacerdote', 1, 'tierra', 'guru', 'curar', ['Acólito', 'Sacerdote Bendecido', 'Sumo Sacerdote de Texel'], ['Dedica su vida a curar a quienes protegen el reino.', 'Sus bendiciones han salvado a más soldados de los que puede recordar.', 'Es el guía espiritual de todo Texel, y su fe cura donde la magia común falla.']);
addFamily('thor', 3, 'rayo', 'campeon', 'golpe', ['Joven del Martillo', 'Guerrero de Asgard', 'Thor, Dios del Trueno'], ['Solo el digno puede levantar su martillo... y desatar la tormenta.', 'Cada batalla en Asgard fortalece más su brazo — y su martillo.', 'Solo él puede levantar el martillo, y solo él puede desatar la tormenta que trae.']);
addFamily('gladiador', 1, 'tierra', 'campeon', 'golpe', ['Esclavo de la Arena', 'Gladiador Veterano', 'Campeón del Coliseo'], ['Ha sobrevivido a cientos de combates ante multitudes sedientas de sangre.', 'Cada victoria en la arena le gana más respeto — y más enemigos.', 'Es el campeón indiscutido del coliseo, y las multitudes corean su nombre.']);
addFamily('hombrehielo', 1, 'agua', 'brujo', 'debilitar', ['Escarcha Viviente', 'Hombre de Hielo', 'Avatar del Invierno Eterno'], ['Congela todo lo que toca, incluso el ánimo de sus rivales.', 'El frío que desprende ya congela el aire a su alrededor.', 'Es el invierno eterno hecho carne: nada sobrevive mucho tiempo a su lado.']);
addFamily('odin', 3, 'rayo', 'guru', 'bendicion', ['Joven Vidente', 'Odín, el Errante', 'Odín, Padre de Todo'], ['Sacrificó un ojo por sabiduría, y con ella gobierna Asgard.', 'Cada viaje errante le enseña un secreto más del destino de los mundos.', 'Gobierna Asgard entero con la sabiduría que pagó con su propio ojo.']);
addFamily('sunwukong', 3, 'viento', 'picaro', 'furia', ['Mono de Piedra', 'Rey Mono', 'Sun Wukong, el Sabio Igualado al Cielo'], ['Su bastón puede crecer hasta el cielo... y su ingenio, aún más alto.', 'Su bastón crece más alto con cada batalla que libra.', 'Ni el cielo mismo ha logrado igualar su ingenio.']);
addFamily('leonhumanizado', 2, 'tierra', 'campeon', 'grito', ['Cachorro de León', 'Guerrero León', 'Rey de la Sabana Dorada'], ['Su rugido basta para que la manada entera se ponga en pie.', 'Su rugido ya reúne a toda la manada en un solo instante.', 'Gobierna la sabana dorada como el rey indiscutido que siempre fue.']);
...
addFamily('deerwoman', 2, 'tierra', 'picaro', 'aturdir', ['Joven del Bosque', 'Deer Woman', 'Deer Woman, Espíritu Vengador'], ['Atrae a quien le falta el respeto al bosque... y no todos vuelven.', 'Su presencia ya avisa a quienes le faltan el respeto al bosque.', 'Es el espíritu vengador del bosque: quien la ofende rara vez regresa.']);
addFamily('gatubela', 2, 'viento', 'picaro', 'aturdir', ['Aprendiz Felina', 'Gatúbela', 'Reina de los Tejados'], ['Se mueve entre las sombras de la ciudad sin dejar ni un solo rastro.', 'Se desliza entre los tejados de la ciudad sin dejar ni un solo sonido.', 'Gobierna los tejados de la ciudad como su propio reino secreto.']);
addFamily('afrodita', 3, 'agua', 'guru', 'bendicion', ['Doncella Nacida del Mar', 'Afrodita en Flor', 'Afrodita, Diosa del Amor'], ['Nació de la espuma del mar y con ella trajo la belleza al mundo.', 'Su belleza ya desarma tanto a aliados como a enemigos por igual.', 'Es la diosa del amor, y ningún corazón en Texel es inmune a su presencia.']);
addFamily('basajaun', 2, 'tierra', 'campeon', 'escudo', ['Joven Basajaun', 'Basajaun del Bosque', 'Basajaun, Señor de los Bosques Vascos'], ['Protege a los rebaños del bosque de cualquier peligro, incluso de los cazadores.', 'Vigila cada rebaño del bosque con paciencia inquebrantable.', 'Es el señor de los bosques vascos, y ningún cazador se atreve a desafiarlo.']);
addFamily('icaro', 1, 'viento', 'explorador', 'furia', ['Aprendiz de Alas de Cera', 'Ícaro en Vuelo', 'Ícaro, el que Desafió al Sol'], ['Voló más alto de lo que nadie creía posible... y pagó el precio por ello.', 'Cada vuelo lo lleva más alto de lo que sus alas de cera deberían soportar.', 'Desafió al sol mismo, y su leyenda vuela más alto de lo que él jamás llegó.']);
addFamily('orangutan', 1, 'tierra', 'campeon', 'golpe', ['Cría de Orangután', 'Orangután de la Selva', 'Sabio Orangután de la Jungla'], ['Tan fuerte como paciente, rara vez pelea sin motivo.', 'Su paciencia solo es superada por la fuerza que guarda para cuando de verdad la necesita.', 'Es el sabio indiscutido de la jungla, respetado por su fuerza y su calma.']);
addFamily('poseidon', 3, 'agua', 'campeon', 'grito', ['Joven del Tridente', 'Guardián de las Mareas', 'Poseidón, Señor de los Mares'], ['Con un golpe de su tridente puede calmar — o desatar — cualquier tormenta.', 'Su tridente ya agita mareas enteras con un solo golpe.', 'Es el señor de los mares, y ninguna tormenta se forma sin su voluntad.']);
addFamily('davyjones', 2, 'agua', 'brujo', 'debilitar', ['Marinero Maldito', 'Davy Jones, el Maldito', 'Davy Jones, Capitán del Abismo'], ['Su barco solo aparece cuando ya es demasiado tarde para escapar.', 'Su maldición se ha vuelto tan profunda como el abismo que ahora gobierna.', 'Es el capitán del abismo, y su barco solo aparece cuando ya no hay escapatoria.']);
addFamily('velociraptor', 1, 'tierra', 'picaro', 'furia', ['Cría de Velocirraptor', 'Velocirraptor Cazador', 'Líder de la Manada de Raptores'], ['Caza en manada, y para cuando lo ves, ya es tarde.', 'Su manada ha aprendido a cazar en perfecta coordinación bajo su liderazgo.', 'Es el líder indiscutido de la manada, y nadie escapa de su emboscada.']);
addFamily('hombrepez', 1, 'agua', 'explorador', 'debilitar', ['Joven Hombre Pez', 'Hombre Pez de las Profundidades', 'Ancestro de las Profundidades'], ['Respira bajo el agua tan fácil como tú respiras aire.', 'Ha explorado profundidades donde ningún otro ser humano ha logrado sobrevivir.', 'Es el ancestro de las profundidades, y el mar entero reconoce su linaje.']);
addFamily('bastet', 2, 'fuego', 'guru', 'curar', ['Gatita Sagrada', 'Sacerdotisa de Bastet', 'Bastet, Diosa Felina'], ['Protectora de los hogares, y de quien tenga la suerte de ganarse su favor.', 'Su templo recibe cada vez más ofrendas de quienes buscan su favor.', 'Es la diosa felina, y su bendición protege cada hogar que la honra.']);
addFamily('orcahumanoide', 2, 'agua', 'campeon', 'golpe', ['Joven Orca', 'Guerrera Orca', 'Matriarca de las Orcas'], ['Caza en manada y nunca deja a un miembro de su familia atrás.', 'Lidera a su manada en cacerías cada vez más coordinadas.', 'Es la matriarca de las orcas, y ningún miembro de su familia queda atrás jamás.']);
addFamily('mujerconejo', 1, 'tierra', 'picaro', 'aturdir', ['Joven Conejo', 'Mujer Conejo', 'Gran Coneja de la Luna'], ['Tan rápida que apenas la ves antes de que ya haya golpeado.', 'Su velocidad ya es casi imposible de seguir a simple vista.', 'Es la Gran Coneja de la Luna, y nadie logra anticipar su golpe.']);
addFamily('tiburonmartillo', 2, 'agua', 'picaro', 'furia', ['Grumete Martillo', 'Pirata Tiburón Martillo', 'Capitán de los Siete Mares'], ['Su cabeza en forma de martillo esconde un instinto asesino infalible.', 'Su instinto de pirata se ha vuelto tan afilado como su propia mordida.', 'Es el capitán indiscutido de los siete mares, y su bandera es temida en cada puerto.']);
addFamily('espantapajaros', 1, 'tierra', 'brujo', 'debilitar', ['Espantapájaros Roto', 'Espantapájaros Animado', 'Guardián del Campo Maldito'], ['Cobró vida una noche sin luna, y desde entonces vigila el campo.', 'Cada noche sin luna afianza un poco más su extraña vida.', 'Es el guardián del campo maldito, y nada cruza sus tierras sin su permiso.']);
addFamily('escorpionhumanoide', 2, 'tierra', 'picaro', 'veneno', ['Joven Escorpión', 'Guerrero Escorpión', 'Señor del Aguijón Mortal'], ['Su aguijón lleva un veneno que debilita hasta al rival más fuerte.', 'Su aguijón se ha vuelto tan letal que un solo roce basta para debilitar a cualquiera.', 'Es el señor del aguijón mortal, y ningún antídoto conocido detiene su veneno.']);
...
addFamily('cangrejo', 1, 'agua', 'campeon', 'escudo', ['Cangrejo Pequeño', 'Cangrejo Acorazado', 'Rey Cangrejo de las Rocas'], ['Su caparazón es tan duro que pocas armas logran atravesarlo.', 'Su caparazón se ha endurecido tanto que ya ni las armas más afiladas lo atraviesan.', 'Es el rey cangrejo de las rocas, y su territorio en la costa no admite intrusos.']);
addFamily('zapador', 1, 'tierra', 'explorador', 'debilitar', ['Zapador Novato', 'Zapador de Túneles', 'Maestro Zapador de las Profundidades'], ['Conoce cada túnel bajo Texel mejor que su propia casa.', 'Cada túnel nuevo que excava conecta un rincón más de Texel bajo tierra.', 'Es el maestro indiscutido de las profundidades, y ningún mapa conoce mejor que él.']);
addFamily('plantacarnivora', 1, 'tierra', 'brujo', 'debilitar', ['Brote Carnívoro', 'Planta Carnívora', 'Devoradora de las Profundidades del Bosque'], ['Atrae a sus presas con un aroma dulce... y no las suelta jamás.', 'Su aroma ya atrae presas desde cada vez más lejos del bosque.', 'Es la devoradora de las profundidades del bosque, y nada que atrapa vuelve a salir.']);
addFamily('estatua', 2, 'tierra', 'campeon', 'escudo', ['Estatua Agrietada', 'Estatua Animada', 'Coloso de Piedra Viviente'], ['Permanece inmóvil durante siglos... hasta que alguien comete el error de despertarla.', 'Cada siglo inmóvil acumula más poder bajo su superficie de piedra.', 'Es un coloso de piedra viviente, y su despertar puede derribar murallas enteras.']);
addFamily('tortugahumanoide', 1, 'agua', 'campeon', 'escudo', ['Tortuga Guerrera Novata', 'Tortuga Guerrera Veterana', 'Maestra Tortuga del Caparazón Eterno'], ['Su caparazón ha detenido lanzas, flechas y hasta el paso del tiempo.', 'Su caparazón ha soportado incontables batallas sin ceder ni un centímetro.', 'Es la maestra del caparazón eterno, y ningún golpe conocido ha logrado quebrarla.']);
...
addFamily('kappa', 1, 'agua', 'picaro', 'aturdir', ['Kappa Juguetón', 'Kappa de las Corrientes', 'Kappa Maestro del Estanque'], ['Guarda un cuenco de agua sagrada en la cabeza: si se derrama, pierde todo su poder.', 'Ha aprendido a proteger su cuenco en pleno combate sin derramar ni una gota.', 'Ningún río de Texel se cruza sin su permiso, y su cuenco nunca se ha vaciado.']);
addFamily('tanuki', 1, 'tierra', 'explorador', 'debilitar', ['Tanuki Curioso', 'Tanuki Embaucador', 'Gran Tanuki de las Mil Formas'], ['Puede transformar su propio cuerpo para parecer cualquier cosa... o cualquiera.', 'Sus disfraces ya engañan hasta a quien conoce bien sus trucos.', 'Ha adoptado tantas formas que ya nadie recuerda cuál es la suya de verdad.']);
addFamily('salamandraignea', 1, 'fuego', 'brujo', 'arrasar', ['Cría de Salamandra', 'Salamandra de Brasas', 'Salamandra del Corazón del Volcán'], ['Nació en el centro de una hoguera y jamás ha sentido frío.', 'Las brasas por las que camina se reavivan solas a su paso.', 'Vive en el corazón de un volcán, donde ni la lava logra herirla.']);
addFamily('thunderbird', 1, 'rayo', 'explorador', 'furia', ['Cría de Thunderbird', 'Thunderbird Joven', 'Thunderbird de las Tormentas'], ['Cada aleteo suyo hace crepitar el aire con pequeñas chispas.', 'Ya es capaz de convocar una tormenta con solo alzar el vuelo.', 'Su vuelo desata tormentas que se ven llegar desde el otro lado de Texel.']);
addFamily('selkie', 1, 'agua', 'guru', 'purificar', ['Cría de Selkie', 'Selkie de las Mareas', 'Selkie Guardiana de su Piel'], ['Su piel de foca guarda toda su magia — y todo su secreto.', 'Ha aprendido a moverse entre ambas formas sin perder ni un ápice de su don.', 'Nadie que le arrebate su piel ha logrado quedársela para siempre.']);

addFamily('babayaga', 2, 'tierra', 'brujo', 'debilitar', ['Aprendiz de Baba Yaga', 'Baba Yaga Errante', 'Baba Yaga, Señora del Bosque Negro'], ['Vive en una choza que se mueve sobre patas de gallina, siempre un paso por delante.', 'Su mortero vuela cada vez más rápido entre los árboles del bosque.', 'Ningún viajero perdido en el bosque negro escapa a su maldición.']);
addFamily('tengu', 2, 'viento', 'explorador', 'furia', ['Tengu Aprendiz', 'Tengu Espadachín', 'Gran Tengu de las Montañas'], ['Domina el viento y la espada con la misma facilidad con la que respira.', 'Su corte ya es tan rápido como la ráfaga que lo acompaña.', 'Ningún samurái de Texel se atreve a desafiarlo en las cumbres que vigila.']);
addFamily('chupacabra', 2, 'tierra', 'picaro', 'drenar', ['Cría de Chupacabra', 'Chupacabra Nocturno', 'Chupacabra, Terror del Ganado'], ['Ataca de noche y desaparece antes de que nadie pueda verlo bien.', 'Cada mordisco lo deja más fuerte y a su presa más débil.', 'Ningún rebaño de Texel está a salvo cuando cae la noche y él anda cerca.']);
addFamily('huldra', 2, 'tierra', 'guru', 'bendicion', ['Joven Huldra', 'Huldra del Bosque Nórdico', 'Huldra, Reina del Bosque Encantado'], ['Tan hermosa como peligrosa para quien se acerca sin cuidado a su bosque.', 'Su canto ya calma tanto a las bestias del bosque como a sus propios aliados.', 'Gobierna el bosque encantado, y su cola escondida es el único secreto que guarda.']);
addFamily('naga', 2, 'agua', 'brujo', 'arrasar', ['Joven Naga', 'Naga Guardiana del Río', 'Naga, Soberana de las Aguas Sagradas'], ['Mitad mujer, mitad serpiente, vigila las aguas donde nadie más se atreve a nadar.', 'Su veneno ya es tan sagrado como mortal para quien profana su río.', 'Ningún tesoro sumergido en Texel está más protegido que el suyo.']);

addFamily('ganesha', 3, 'tierra', 'guru', 'purificar', ['Joven de Cabeza de Elefante', 'Heraldo de Ganesha', 'Ganesha, Señor de los Obstáculos'], ['Ningún camino se le resiste, por más piedras que tenga en medio.', 'Cada obstáculo que aparta se convierte en una lección para quien lo observa.', 'Ningún obstáculo, físico o mágico, ha logrado detenerlo jamás.']);
addFamily('amaterasu', 3, 'fuego', 'guru', 'revivir', ['Doncella del Amanecer', 'Heraldo de Amaterasu', 'Amaterasu, Diosa del Sol Naciente'], ['Su luz devuelve el color a cualquier cosa que haya tocado la oscuridad.', 'Una vez se escondió y el mundo entero perdió su luz hasta que decidió volver.', 'Todo Texel depende de su luz — sin ella, ni el amanecer volvería a llegar.']);
addFamily('susanoo', 3, 'agua', 'campeon', 'grito', ['Joven de la Tormenta', 'Guerrero de las Mareas Bravas', 'Susanoo, Señor de las Tormentas'], ['Su espada ha derrotado serpientes de ocho cabezas y tormentas enteras.', 'Cada batalla en el mar desata una tormenta a su alrededor.', 'Ni su propia hermana, la diosa del sol, se atreve a desafiar su furia en el mar.']);
addFamily('anansi', 3, 'tierra', 'picaro', 'veneno', ['Joven Tejedor', 'Anansi el Embaucador', 'Anansi, Señor de las Telarañas del Destino'], ['Teje trampas tan finas que su presa nunca las ve venir.', 'Sus historias han engañado hasta a los propios dioses de su panteón.', 'Sus telarañas conectan cada rincón de Texel, y todas le devuelven algún secreto.']);
addFamily('tlaloc', 3, 'rayo', 'brujo', 'arrasar', ['Joven de la Lluvia', 'Heraldo de Tlaloc', 'Tlaloc, Señor de la Lluvia y el Trueno'], ['Decide con un gesto si los campos de Texel florecen o se secan.', 'Cada tormenta que convoca fortalece un poco más su dominio sobre el cielo.', 'Ningún campesino de Texel siembra sin antes rezar por su favor.']);

// --- Segunda ronda de mitologías/folclores poco representados (celta,
// escocés, eslavo, cryptids americanos, folclore amazónico) — 10 familias
// de tier 1 pedidas explícitamente por el usuario.
addFamily('fuegofatuo', 1, 'fuego', 'brujo', 'debilitar', ['Chispa Errante', 'Fuego Fatuo del Pantano', 'Fuego Fatuo, Guía de los Perdidos'], ['Su luz parpadeante promete un camino seguro... que rara vez lo es.', 'Cada viajero que sigue su luz se adentra un poco más en el pantano.', 'Nadie que haya seguido su luz hasta el final ha vuelto a contar el camino de vuelta.']);
addFamily('knocker', 1, 'tierra', 'explorador', 'furia', ['Knocker Aprendiz', 'Knocker de las Vetas', 'Gran Knocker de la Mina Profunda'], ['Golpea la roca para avisar de un derrumbe... o para provocarlo él mismo.', 'Conoce cada veta de la mina mejor que los propios mineros que la excavaron.', 'Ninguna mina de Texel se derrumba sin que él lo haya decidido antes.']);
addFamily('kelpie', 1, 'agua', 'picaro', 'furia', ['Potrillo Kelpie', 'Kelpie de las Aguas Oscuras', 'Kelpie, Terror del Lago'], ['Su pelaje reluciente esconde una fuerza capaz de arrastrar a cualquier jinete.', 'Ya ha aprendido a parecer manso justo hasta el momento de atacar.', 'Ningún jinete que monta su lomo ha vuelto a pisar tierra firme.']);
addFamily('perronegro', 1, 'viento', 'campeon', 'grito', ['Cachorro de Ojos de Brasa', 'Perro Negro de los Caminos', 'Perro Negro, Presagio de Tormenta'], ['Sus ojos brillan como brasas cuando algo malo está por ocurrir.', 'Su aullido ya se escucha antes de que la tormenta siquiera se forme.', 'Ningún viajero que cruza su camino de noche olvida el presagio de sus ojos.']);
addFamily('trolpuente', 1, 'tierra', 'campeon', 'escudo', ['Trol de Puente Novato', 'Trol Guardián del Cruce', 'Gran Trol, Señor del Puente Antiguo'], ['No deja pasar a nadie sin cobrar antes su peaje.', 'Su puente ya es tan infranqueable como él mismo.', 'Ningún puente de Texel es más temido — ni más seguro de cruzar, si se paga el precio.']);
addFamily('jackalope', 1, 'tierra', 'explorador', 'furia', ['Jackalope Curioso', 'Jackalope de las Llanuras', 'Jackalope, Leyenda de la Pradera'], ['Su cornamenta es tan real como difícil de creer para quien no la ha visto.', 'Es tan rápido que su embestida llega antes de que se le vea venir.', 'Ningún cazador de la pradera ha logrado atraparlo dos veces.']);
addFamily('rusalka', 1, 'agua', 'guru', 'bendicion', ['Joven Rusalka', 'Rusalka del Río Tranquilo', 'Rusalka, Espíritu de las Aguas Dulces'], ['Su canto flota sobre el agua mucho antes de que se la pueda ver.', 'Su melodía ya calma tanto el río como a quien la escucha.', 'Ningún río de Texel corre en calma sin que ella lo permita.']);
addFamily('mothman', 1, 'rayo', 'picaro', 'aturdir', ['Cría de Mothman', 'Mothman de las Sombras', 'Mothman, Presagio Alado'], ['Sus ojos brillan justo antes de que algo se tuerza.', 'Quien cruza su mirada se queda paralizado un instante de más.', 'Ninguna tormenta llega a Texel sin que él aparezca primero para anunciarla.']);
addFamily('gremlin', 1, 'rayo', 'explorador', 'debilitar', ['Gremlin Curioso', 'Gremlin Saboteador', 'Gremlin Maestro del Desguace'], ['Con solo tocar un mecanismo, ya sabe exactamente cómo romperlo.', 'Ninguna armadura ni arma resiste mucho tiempo entre sus manos traviesas.', 'No hay maquinaria en Texel que sobreviva intacta a su curiosidad.']);
addFamily('boto', 1, 'agua', 'brujo', 'drenar', ['Cría de Boto', 'Boto de las Aguas Rosadas', 'Boto, Seductor del Amazonas'], ['De día es solo un delfín rosado... de noche, algo muy distinto.', 'Su encanto nocturno ya atrae a más de un incauto hacia el río.', 'Nadie que ha bailado con él bajo la luna ha vuelto a recordar bien la noche.']);
