...
addFamily("domadordragones", 2, "fuego", "campeon", "grito", ["Aprendiz de las Cadenas","Domador de Dragones de Escamas Cicatrizadas","Gran Domador, Señor de las Bestias Aladas"], ["Aprende a base de quemaduras que ninguna cadena doma a un dragón sin ganarse su respeto primero.","Sus cicatrices cuentan la historia de cada dragón que ha sometido a su voluntad.","Es el señor de las bestias aladas, y ningún dragón de Texel vuela ya sin su permiso."], true);
...
addFamily("domadordebestias", 2, "viento", "explorador", "grito", ["Aprendiz de la Jaula","Domador de Bestias del Circo Itinerante","Gran Domador, el que Ninguna Fiera Desobedece"], ["Aprende a leer el temperamento de cada fiera antes de acercarse a su jaula.","Su circo itinerante ya reúne a las fieras más peligrosas de Texel sin que ninguna se atreva a desobedecerlo.","Es aquel a quien ninguna fiera desobedece, y su látigo apenas necesita chasquear una vez."], true);
...
addFamily("mulan", 2, "rayo", "picaro", "dobleGolpe", ["Joven Recluta Disfrazada","Mulan, la Guerrera del Ejército del Norte","Mulan, la que Salvó un Imperio"], ["Se alista en el ejército disfrazada, decidida a proteger a su familia a cualquier precio.","Su espada ya se ha ganado el respeto de todo el ejército del norte, aunque nadie conozca su secreto.","Es la que salvó un imperio entero, y su nombre se sigue cantando aunque muchos ya olvidaron por qué empezó a luchar."], true);
