...
addFamily("ganesha", 3, "tierra", "guru", "bendicion", ["Cría de Ganesha","Ganesha, Portador de Sabiduría","Ganesha, Señor de los Nuevos Comienzos"], ["Con trompa de elefante y mente de sabio, nada empieza bien sin su bendición.","Ya retira obstáculos del camino de ejércitos enteros con un solo gesto.","Ningún comienzo en Texel se considera de buen augurio sin que él lo bendiga primero."], false);
addFamily("amaterasu", 3, "fuego", "guru", "curar", ["Joven Diosa del Alba","Amaterasu en Vuelo","Amaterasu, Diosa del Sol Naciente"], ["Su luz devuelve el calor a quien lo ha perdido en la más larga de las noches.","Su resplandor ya cura heridas que la oscuridad creía eternas.","Es el sol mismo hecho diosa, y su luz devuelve la vida allí donde se posa."], false);
addFamily("susanoo", 3, "rayo", "campeon", "furia", ["Joven Dios de la Tormenta","Susanoo, Señor de los Mares y Tormentas","Susanoo, Domador de la Serpiente de Ocho Cabezas"], ["Expulsado del cielo por su temperamento, desató su furia contra el mar embravecido.","Cada tormenta que provoca ya es tan temida como su propio genio.","Domó a la serpiente de ocho cabezas, y desde entonces nada en la tierra lo desafía."], false);
addFamily("anansi", 2, "tierra", "explorador", "sabotaje", ["Araña Curiosa","Anansi, Tejedor de Historias","Anansi, Dueño de Todas las Historias del Mundo"], ["Teje su tela con la misma facilidad con la que teje sus engaños.","Sus historias ya han engañado a dioses mucho más fuertes que él.","Compró todas las historias del mundo con astucia, y ninguna se cuenta ya sin su nombre."], false);
addFamily("tlaloc", 2, "agua", "guru", "arrasar", ["Portador de Lluvia Menor","Tlaloc, Señor de la Tormenta","Tlaloc, Dueño de las Cuatro Lluvias"], ["Un gesto suyo basta para que el cielo entero se abra en tormenta.","Sus tormentas ya arrasan cosechas enteras cuando se enfada.","Gobierna las cuatro lluvias sagradas, y ningún campo florece sin su permiso."], false);
addFamily("hanuman", 2, "fuego", "campeon", "escudo", ["Joven Devoto de Cola Larga","Hanuman, Guerrero Leal","Hanuman, Protector Eterno de los Suyos"], ["Su lealtad es tan grande como la montaña que una vez cargó sobre sus hombros.","Ya ha cruzado océanos enteros de un salto por proteger a quien lo necesita.","Es el protector eterno de los suyos, y ninguna distancia ha sido nunca demasiado grande para él."], false);
addFamily("kali", 3, "tierra", "brujo", "golpeGracia", ["Sombra de la Destructora","Kali en Danza de Guerra","Kali, Devoradora del Tiempo"], ["Su danza anuncia el final de algo, aunque nadie sepa todavía el qué.","Cada collar que porta cuenta una batalla que puso fin a algo mucho más grande.","Es la devoradora del tiempo mismo, y ante ella hasta los ciclos del mundo terminan."], false);
addFamily("cernunnos", 3, "tierra", "guru", "bendicion", ["Joven de la Cornamenta","Cernunnos, Señor de los Bosques Salvajes","Cernunnos, Guardián de Todo lo Vivo"], ["Cada ciervo del bosque reconoce en su cornamenta a uno de los suyos.","Su bendición ya hace florecer el bosque entero a su paso.","Es el guardián de todo lo vivo, y ningún cazador entra en su bosque sin su permiso."], false);
addFamily("maui", 3, "rayo", "explorador", "rafaga", ["Joven Semidiós Embaucador","Maui, Domador del Sol","Maui, Semidiós de las Mil Hazañas"], ["Robó el fuego y ató el sol solo para tener más horas de aventura por delante.","Cada hazaña suya ya se cuenta antes de que termine de completar la siguiente.","Sus mil hazañas son ya leyenda, y ninguna isla de Texel olvida su nombre."], false);
...
addFamily("xolotl", 2, "rayo", "explorador", "revivir", ["Cachorro del Ocaso","Xolotl, Guía del Inframundo","Xolotl, Señor de las Almas que Vuelven"], ["Guía a las almas perdidas por el camino que ni ellas mismas recuerdan.","Ya ha cruzado el inframundo tantas veces que conoce cada uno de sus atajos.","Es el señor de las almas que vuelven, y ninguna se pierde ya bajo su guía."], false);
addFamily("coatlicue", 3, "tierra", "brujo", "debilitar", ["Hija de la Falda de Serpientes","Coatlicue en Vigilia","Coatlicue, Madre de Todo lo que Nace y Muere"], ["Viste una falda de serpientes vivas, y ninguna se atreve a desobedecerla.","Su presencia ya marchita todo lo que la vida no protege con fuerza.","Es la madre de todo lo que nace y muere, y ante ella el ciclo entero del mundo se inclina."], false);
addFamily("mamiwata", 2, "agua", "guru", "curar", ["Joven Espíritu del Río","Mami Wata, Señora de las Aguas","Mami Wata, Madre de Todos los Ríos"], ["Su canto atrae tanto la fortuna como la perdición, según a quién visite.","Sus aguas ya curan males que ningún sanador de tierra firme logra sanar.","Es la madre de todos los ríos, y su favor decide quién prospera cerca de sus orillas."], false);
addFamily("leprechaun", 1, "tierra", "explorador", "aturdir", ["Duende de Bolsillos Llenos","Leprechaun Escurridizo","Leprechaun, Guardián del Oro al Final del Arcoíris"], ["Promete un tesoro y desaparece antes de que puedas pedírselo dos veces.","Ya ha escapado de más cazadores de tesoros de los que puede recordar.","Es el guardián del oro al final del arcoíris, y nadie ha logrado seguirlo hasta él."], false);
addFamily("puca", 1, "viento", "explorador", "sabotaje", ["Sombra Cambiante","Púca de las Encrucijadas","Gran Púca, Señor de las Mil Formas de la Noche"], ["Nunca se sabe si el animal que cruza tu camino de noche es lo que parece.","Cambia de forma cada vez más rápido, sin dejar tiempo a que lo reconozcan.","Es el señor de las mil formas de la noche, y nadie ha visto jamás su rostro verdadero."], false);
addFamily("apsara", 1, "viento", "explorador", "rafaga", ["Aprendiz de Danza Celestial","Apsara de los Salones Eternos","Gran Apsara, Danzarina del Cielo Mismo"], ["Cada paso de su danza roba el aliento a quien tiene la suerte de verla.","Su danza ya mueve el viento a su alrededor como si respondiera a su ritmo.","Danza en los salones del cielo mismo, y ningún mortal olvida haberla visto una vez."], false);
addFamily("naga", 2, "agua", "brujo", "veneno", ["Joven de Sangre Serpentina","Naga de las Aguas Profundas","Reina Naga del Río Sagrado"], ["Su mitad serpiente esconde un veneno tan sagrado como letal.","Su veneno ya se ha vuelto tan sagrado en su templo como temido fuera de él.","Gobierna el río sagrado entero, y ninguna criatura de sus aguas se mueve sin su permiso."], false);
addFamily("tikbalang", 2, "tierra", "picaro", "dobleGolpe", ["Potrillo de Dos Piernas","Tikbalang de los Caminos Perdidos","Gran Tikbalang, Señor de las Sendas que Engañan"], ["Con cabeza de caballo y piernas larguísimas, hace perder el rumbo a cualquiera.","Sus sendas engañan cada vez a más viajeros que juraban conocer el camino.","Es el señor de las sendas que engañan, y solo él conoce el camino de vuelta."], false);
addFamily("simurgh", 2, "viento", "guru", "curar", ["Cría de Ave Sabia","Simurgh de las Alturas Eternas","Gran Simurgh, Guardiana de la Sabiduría del Mundo"], ["Ha vivido tantos ciclos del mundo que ya recuerda cómo empezaron todos.","Sus alas ya curan con el mismo viento que desatan al volar.","Es la guardiana de la sabiduría del mundo, y ningún ave ha volado jamás tan alto como ella."], false);
addFamily("qinglong", 2, "viento", "brujo", "arrasar", ["Cría del Dragón Azur","Qinglong, Guardián del Este","Gran Qinglong, Dragón Celeste del Amanecer"], ["Nació con la primera luz del este, y con ella sigue guardando el amanecer.","Su aliento ya arrasa nubes enteras cuando surca el cielo del amanecer.","Es el guardián celeste del este, y ningún amanecer llega a Texel sin su bendición."], false);
...
addBoss('jormungandr', 'agua', 'brujo', 'arrasar', 'Jörmungandr, la Serpiente que Rodea el Mundo', 'Tan grande que su cuerpo entero rodea el océano y se muerde su propia cola — el día que la suelte, los nueve mundos temblarán.', 'legendario', false, { hp: 2600, atk: 420, def: 380, agi: 220, wis: 425 });
addBoss('hades', 'tierra', 'brujo', 'debilitar', 'Hades, Señor del Inframundo', 'Gobierna el reino de los muertos con una justicia fría que ni los propios dioses se atreven a cuestionar.', 'legendario', false, { hp: 1750, atk: 380, def: 410, agi: 210, wis: 400 });
addBoss('hel', 'agua', 'brujo', 'corromper', 'Hel, Soberana de los Muertos sin Honor', 'Mitad rostro de viva, mitad de cadáver, decide el destino de quienes no cayeron con gloria en la batalla.', 'legendario', false, { hp: 1700, atk: 365, def: 390, agi: 200, wis: 390 });
addBoss('set', 'tierra', 'brujo', 'sabotaje', 'Set, Señor de las Tormentas y el Caos', 'Asesinó a su propio hermano por el trono, y desde entonces el caos que siembra no conoce límites.', 'legendario', false, { hp: 1650, atk: 347, def: 355, agi: 200, wis: 345 });
addBoss('fafnir', 'fuego', 'campeon', 'golpe', 'Fafnir, el Dragón de la Avaricia', 'Su codicia por un tesoro maldito lo transformó en el dragón más temido de su época.', 'legendario', false, { hp: 1780, atk: 230, def: 420, agi: 110, wis: 70 });
addBoss('anzu', 'viento', 'brujo', 'aturdir', 'Anzu, el Ave-Demonio de la Tormenta', 'Robó la Tablilla de los Destinos a los propios dioses, y desde entonces el trueno le obedece.', 'legendario', false, { hp: 1350, atk: 295, def: 250, agi: 230, wis: 270 });
addBoss('simbionte', 'rayo', 'brujo', 'perforar', 'El Simbionte Devorador', 'Cayó de otro mundo y se fusionó con el primer cuerpo que encontró — ya no se sabe dónde termina la bestia y empieza su portador.', 'legendario', false, { hp: 1200, atk: 335, def: 270, agi: 250, wis: 260 });
addBoss('titancolosal', 'tierra', 'campeon', 'golpe', 'El Titán Colosal', 'Ninguna muralla construida por manos mortales ha resistido jamás su avance.', 'legendario', false, { hp: 3350, atk: 280, def: 650, agi: 140, wis: 90 });
addBoss('kaiju', 'agua', 'campeon', 'arrasar', 'El Kaiju de las Profundidades', 'Emergió del fondo del océano una sola vez, y esa vez bastó para borrar una costa entera del mapa.', 'legendario', false, { hp: 3200, atk: 355, def: 550, agi: 130, wis: 100 });
addBoss('grendel', 'tierra', 'campeon', 'furia', 'Grendel, el Devorador de Salones', 'Ningún salón de guerreros, por bien custodiado que esté, ha sobrevivido intacto a una de sus visitas nocturnas.', 'legendario', false, { hp: 1580, atk: 180, def: 280, agi: 90, wis: 40 });
addBoss('jerseydevil', 'viento', 'brujo', 'debilitar', 'El Jersey Devil', 'Nadie que ha escuchado su chillido en mitad del bosque ha vuelto a dormir tranquilo.', 'legendario', false, { hp: 550, atk: 138, def: 125, agi: 135, wis: 110 });
