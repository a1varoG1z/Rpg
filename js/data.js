...
addFamily("musashi", 3, "viento", "picaro", "dobleGolpe", ["Joven Ronin Errante","Musashi, el de las Dos Espadas","Musashi, el Espadachín Invicto"], ["Empuña una espada en cada mano, y ninguna de las dos conoce la derrota.","Ha ganado más de sesenta duelos sin perder ni uno solo en toda su vida.","Es el espadachín invicto, y su estilo de dos espadas ya es leyenda en cada dojo de Texel."], false);
addFamily("guanyu", 3, "rayo", "campeon", "golpe", ["Joven Portador de la Alabarda","Guan Yu, el de la Barba Larga","Guan Yu, Dios de la Guerra y la Lealtad"], ["Jura lealtad eterna a sus hermanos de armas, y jamás ha roto un juramento.","Su alabarda de dragón verde ya ha decidido batallas enteras de un solo golpe.","Su lealtad y su fuerza lo elevaron a dios de la guerra, y su nombre se invoca aún antes de cada batalla."], false);
addFamily("morfeo", 2, "tierra", "brujo", "aturdir", ["Aprendiz del Polvo de Sueños","El Hombre de Arena","Morfeo, Señor de los Sueños y el Sueño Eterno"], ["Esparce un polvo de arena fina que cierra los ojos del más alerta de los guardias.","Nadie sabe si lo que ha visto tras cruzarse con él fue de verdad, o solo un sueño.","Es el señor de los sueños, y quien cae dormido bajo su arena no decide cuándo despierta."], false);
