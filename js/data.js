...
// --- Octava ronda: Pingüino (tier 1) y 3 animales humanizados tier 2
// (Guepardo, Canguro, Oso Polar) pedidos explícitamente de la lista de
...
// estilo shinigami - todos pedidos explicitamente de la ultima lista de
// sugerencias. hasImages:true desde el alta (el usuario ya esta subiendo
// arte real de forma activa).
addFamily("miguelarcangel", 3, "fuego", "campeon", "golpeGracia", ["Joven Guerrero Alado","Miguel, Portador de la Espada Llameante","Miguel Arcángel, Príncipe de las Huestes Celestiales"], ["Sus alas brillan con una luz que ningún mal se atreve a mirar de frente.","Su espada llameante ya ha derrotado a legiones enteras de sombras.","Es el príncipe de las huestes celestiales, y ningún demonio ha sobrevivido a su juicio final."], true);
addFamily("huitzilopochtli", 3, "fuego", "campeon", "grito", ["Joven Colibrí de Guerra","Huitzilopochtli, Señor de la Guerra Florida","Huitzilopochtli, Dios del Sol y la Guerra"], ["Nació ya armado, listo para defender a su pueblo desde su primer aliento.","Su guerra florida ya ha decidido el destino de imperios enteros.","Es el dios del sol y la guerra, y bajo su estandarte Tenochtitlan nunca conoció la derrota."], true);
addFamily("ballena", 2, "agua", "campeon", "escudo", ["Cría de Ballena","Ballena Guerrera de Canto Profundo","Gran Ballena, Soberana de las Profundidades Abisales"], ["Su canto viaja más lejos bajo el agua que cualquier grito en tierra firme.","Su cuerpo ya ha resistido embestidas que hundirían barcos enteros.","Es la soberana de las profundidades abisales, y ningún océano de Texel se mueve sin su permiso."], true);
addFamily("narval", 2, "agua", "picaro", "perforar", ["Cría de Narval","Narval de Colmillo Certero","Gran Narval, el Unicornio de los Mares Helados"], ["Su colmillo en espiral atraviesa el hielo con la misma facilidad que a un rival.","Ya ha perforado corazas que ningún otro habitante del mar helado lograría rasgar.","Es el unicornio de los mares helados, y ninguna defensa ha detenido jamás su embestida."], true);
addFamily("lince", 2, "tierra", "picaro", "aturdir", ["Cría de Lince","Lince Cazador de Mirada Aguda","Gran Lince, Fantasma de los Bosques Nevados"], ["Sus orejas captan el más mínimo movimiento entre la nieve y las rocas.","Su emboscada ya ha sorprendido a presas que jamás lo vieron acercarse.","Es el fantasma de los bosques nevados, y ningún rastro delata su presencia hasta que es tarde."], true);
addFamily("jirafa", 2, "tierra", "campeon", "golpe", ["Cría de Jirafa","Jirafa Guerrera de Cuello Alto","Gran Jirafa, Centinela de las Llanuras Doradas"], ["Ve venir el peligro desde más lejos que cualquier otro habitante de la sabana.","Su coz ya ha derribado depredadores que la creían una presa fácil.","Es la centinela de las llanuras doradas, y nada se acerca a la manada sin que ella lo note primero."], true);
addFamily("shinigami", 3, "viento", "brujo", "drenar", ["Aprendiz de la Guadaña","Shinigami de las Almas Erradas","Gran Shinigami, Segador de los Mil Mundos"], ["Su guadaña corta el hilo que une el alma al cuerpo sin que nadie lo sienta llegar.","Ya ha guiado a más almas erradas de las que puede contar hacia el más allá.","Es el segador de los mil mundos, y ninguna alma escapa dos veces a su guadaña."], true);
addFamily("morrigan", 3, "viento", "brujo", "debilitar", ["Joven Mórrigan","Dama de los Cuervos","Morrigan, Reina de la Guerra"], ["Aún no ha aprendido a leer el destino de los guerreros en el vuelo de los cuervos.","Sus cuervos ya sobrevuelan cada campo de batalla antes de que se dé el primer golpe.","Es la reina de la guerra, y ningún guerrero cae en combate sin que ella lo haya decidido antes."], true);
addFamily("arturo", 3, "rayo", "campeon", "grito", ["Joven Arturo","Caballero de Camelot","Rey Arturo, Portador de Excalibur"], ["Un joven escudero que todavía no sabe que está destinado a sacar la espada de la piedra.","Ya lidera a los caballeros de Camelot con la misma nobleza con la que empuña su espada.","Es el portador de Excalibur, y ningún reino de Texel ha conocido jamás un rey más justo."], true);
addFamily("jaguar", 2, "tierra", "picaro", "golpeGracia", ["Cría de Jaguar","Jaguar Guerrero","Jaguar Supremo de la Selva"], ["Aprende a cazar en silencio entre la maleza más espesa de la selva.","Su emboscada ya no falla ni contra las presas más grandes de la selva.","Es el supremo de la selva, y ninguna presa herida escapa jamás de sus garras."], true);
addFamily("mandril", 2, "tierra", "campeon", "grito", ["Mandril Común","Mandril de Combate","Mandril, Comandante Supremo"], ["Vive en manada, y ya empieza a hacerse notar entre los suyos.","Sus colmillos y su rugido ya imponen respeto a manadas rivales enteras.","Es el comandante supremo, y ninguna manada rival se atreve a desafiar su autoridad."], true);
addFamily("robinhood", 1, "viento", "explorador", "perforar", ["Arquero del Bosque","Forajido de Sherwood","Robin Hood, Príncipe de los Ladrones"], ["Practica su puntería entre los árboles del bosque, lejos de ojos indiscretos.","Su banda de forajidos ya roba a los ricos sin que la guardia real logre atraparlos.","Es el príncipe de los ladrones, y su flecha nunca falla el blanco que decide robar... o defender."], true);
addFamily("coyote", 1, "tierra", "explorador", "sabotaje", ["Pequeño Coyote","Coyote Explorador","Coyote Señor de las Llanuras"], ["Ya se escabulle solo entre las llanuras, aprendiendo cada uno de sus trucos.","Ha aprendido a burlar trampas y cazadores por igual con la misma facilidad.","Es el señor de las llanuras, y ningún truco es demasiado bueno para él dos veces."], true);
addFamily("puercoespin", 1, "tierra", "campeon", "escudo", ["Cría de Puercoespín","Puercoespín de Púas Afiladas","Gran Puercoespín, Fortaleza de Espinas"], ["Todavía no sabe erizar bien sus púas cuando se asusta.","Sus púas ya se han vuelto tan afiladas que ningún depredador se arriesga a un segundo ataque.","Es la fortaleza de espinas, y nada que se acerque demasiado sale ileso."], true);
addFamily("perezoso", 1, "tierra", "guru", "curar", ["Cría de Perezoso","Perezoso de Garras Firmes","Gran Perezoso, Sabio Lento del Dosel"], ["Se mueve tan despacio que el musgo ya empieza a crecer en su pelaje.","Sus garras firmes ya no sueltan la rama ni en la tormenta más fuerte.","Es el sabio lento del dosel, y quien tiene paciencia para escucharlo aprende más que en toda una vida de prisas."], true);
addFamily("berserker", 2, "rayo", "campeon", "furia", ["Joven Guerrero del Norte","Berserker de Furia Incontenible","Gran Berserker, el que Lucha sin Sentir Dolor"], ["Entrena con el hacha desde niño, soñando con la furia de sus mayores.","Su furia en el campo de batalla ya no distingue entre amigo y enemigo cercano.","Es el que lucha sin sentir dolor, y ningún ejército ha logrado hacerlo retroceder con vida."], true);
addFamily("efrit", 2, "fuego", "brujo", "arrasar", ["Espíritu Menor de las Arenas","Efrit de las Dunas Ardientes","Gran Efrit, Señor del Fuego del Desierto"], ["Nace del calor mismo del desierto cuando el sol pega más fuerte.","Sus dunas ardientes ya se mueven solas allá donde decide caminar.","Es el señor del fuego del desierto, y ninguna caravana cruza sus arenas sin su permiso."], true);
addFamily("guerrerodejade", 2, "tierra", "campeon", "escudo", ["Aprendiz de la Espada Verde","Guerrero de Jade Inquebrantable","Gran Guerrero, Armadura que Nunca se Agrieta"], ["Entrena con una espada tallada en jade que pesa más de lo que aparenta.","Su armadura de jade ya ha detenido golpes que harían añicos cualquier otra coraza.","Es la armadura que nunca se agrieta, y ningún golpe conocido ha dejado ni una sola marca."], true);
addFamily("verdugoenmascarado", 2, "tierra", "picaro", "golpeGracia", ["Aprendiz del Hacha","Verdugo Enmascarado de Sentencias Finales","Gran Verdugo, el que Ejecuta el Destino"], ["Practica con el hacha en silencio, sin que nadie sepa jamás cómo es su rostro.","Sus sentencias finales ya no dejan lugar a un segundo intento.","Es el que ejecuta el destino, y su máscara es lo último que ve quien se enfrenta a él."], true);
addFamily("smoker", 2, "viento", "brujo", "aturdir", ["Soldado de Humo","Cazador de Bruma","General del Humo"], ["Su cuerpo apenas empieza a disolverse en el aire cuando se enfada.","Su bruma ya envuelve a sus enemigos antes de que se den cuenta del peligro.","Es el general del humo, y nadie logra golpear lo que no puede agarrar."], true);
addFamily("shango", 3, "rayo", "campeon", "aturdir", ["Joven Portador del Hacha Doble","Shango, Rey que Domó el Rayo","Shango, Dios del Rayo y la Justicia Yoruba"], ["Empuña un hacha de doble filo mucho antes de aprender a controlar el rayo que lleva dentro.","Ya ha domado el rayo mismo, y lo lanza contra quien se atreve a desafiar su reinado.","Es el dios del rayo y la justicia yoruba, y ningún culpable escapa jamás a su sentencia."], true);
addFamily("beowulf", 3, "agua", "campeon", "golpe", ["Joven Guerrero de los Gauta","Beowulf, el que Mató a Grendel","Beowulf, Rey Legendario de los Gauta"], ["Cruza el mar desde tierras lejanas en busca de una gloria digna de cantarse.","Mató a Grendel con sus propias manos, sin más arma que su fuerza legendaria.","Es el rey legendario de los Gauta, y ningún monstruo de Texel ha vuelto a desafiar a su pueblo desde entonces."], true);
...
// Gollum: pasado de personaje jugable a mob de mapa (petición explícita
// del usuario) — se mueve de FIGHTERS a MOBS sin tocar su tier/rareza/
// lore/id (sigue siendo tier 2: infrecuente/raro/épico), solo cambia de
// lista y de función (addFamily -> addMobFamily). Encaja en zonas de
// cuevas/subterráneos/cripta por su lore ("Criatura de las Cavernas
// Profundas"). La Torre Batalla lo recoge automáticamente en cuanto
// aparece en el pool de relleno de alguna zona (ver buildTorreLevels),
// así que no hace falta tocar nada más para que salga ahí también.
addMobFamily("gollum", 2, "tierra", "picaro", "sabotaje", ["Criatura Consumida","Criatura de las Cavernas Profundas","El que Susurra en la Oscuridad"], ["Una vez fue como cualquiera, hasta que algo que encontró lo cambió para siempre.","Se mueve entre las sombras de las cuevas más profundas sin que nadie lo escuche llegar.","Es el que susurra en la oscuridad, y nadie que se adentra en sus cuevas sale del todo igual."], true);
...
addBoss('garn', 'tierra', 'campeon', 'golpe', 'Garn, el Devorador de Piedra', 'Se alimenta de roca y escupe fragmentos capaces de atravesar una armadura.', 'raro', true, { hp: 1758, atk: 183, def: 210, agi: 54, wis: 47 });
addBoss('nian', 'fuego', 'campeon', 'furia', 'Nian, la Bestia del Año Nuevo', 'Solo el ruido y el color rojo lo mantienen alejado de los pueblos.', 'raro', true, { hp: 1558, atk: 185, def: 173, agi: 65, wis: 44 });
...
addBoss('surtr', 'fuego', 'campeon', 'golpe', 'Surtr, Señor de las Llamas de Muspelheim', 'Su espada ardiente se dice que incendiará los nueve mundos al final de los tiempos.', 'epico', true, { hp: 1944, atk: 177, def: 419, agi: 176, wis: 63 });
addBoss('behemoth', 'tierra', 'campeon', 'golpe', 'Behemoth, la Bestia Primigenia', 'Tan grande y antiguo que su sola existencia desafía toda lógica.', 'epico', true, { hp: 1398, atk: 205, def: 476, agi: 185, wis: 66 });
addBoss('medusa', 'tierra', 'brujo', 'paralisis', 'Medusa, la Gorgona de Mirada Pétrea', 'Una sola mirada a sus ojos convierte a cualquiera en piedra.', 'raro', true, { hp: 1498, atk: 270, def: 156, agi: 86, wis: 189 });
...
addBoss('ammit', 'tierra', 'campeon', 'furia', 'Ammit, Devoradora de Corazones', 'Devora el corazón de quien no es digno de pasar al más allá.', 'raro', true, { hp: 1286, atk: 186, def: 254, agi: 64, wis: 48 });
...
addBoss('leondenemea', 'tierra', 'campeon', 'golpe', 'León de Nemea, Piel Impenetrable', 'Ningún arma forjada por mortales ha logrado atravesar su piel.', 'raro', true, { hp: 1422, atk: 191, def: 228, agi: 83, wis: 57 });
addBoss('pajaroroc', 'viento', 'explorador', 'furia', 'Roc, el Ave que Oscurece el Cielo', 'Sus alas al abrirse tapan el sol entero sobre el desierto.', 'raro', true, { hp: 1212, atk: 228, def: 183, agi: 191, wis: 115 });
addBoss('torodecreta', 'tierra', 'campeon', 'furia', 'Toro de Creta, Furia Desatada', 'Arrasó campos enteros antes de que nadie lograra domarlo.', 'raro', true, { hp: 1616, atk: 182, def: 260, agi: 80, wis: 60 });
addBoss('basilisco', 'tierra', 'brujo', 'debilitar', 'Basilisco, Rey de las Serpientes', 'Su mirada mata, y su veneno no perdona ni a la piedra.', 'epico', true, { hp: 2276, atk: 435, def: 194, agi: 109, wis: 239 });
addBoss('ettin', 'tierra', 'campeon', 'golpe', 'Ettin, el Gigante de Dos Cabezas', 'Dos cabezas significan el doble de mal genio... y el doble de fuerza.', 'epico', true, { hp: 2020, atk: 273, def: 367, agi: 94, wis: 69 });
addBoss('gorgonas', 'tierra', 'brujo', 'debilitar', 'Las Gorgonas, Hermanas de Piedra', 'Donde una gorgona falla, sus hermanas terminan el trabajo.', 'epico', true, { hp: 2054, atk: 395, def: 229, agi: 109, wis: 300 });
addBoss('rakshasa', 'fuego', 'brujo', 'debilitar', 'Rakshasa, el Cambiante Maldito', 'Puede tomar cualquier forma para acercarse a su presa sin ser detectado.', 'epico', true, { hp: 902, atk: 388, def: 388, agi: 216, wis: 287 });
addBoss('manticora', 'fuego', 'picaro', 'furia', 'Mantícora, la Devoradora de Hombres', 'Su cola de escorpión dispara espinas tan letales como su mordida.', 'epico', true, { hp: 1254, atk: 414, def: 149, agi: 276, wis: 87 });
addBoss('liche', 'rayo', 'brujo', 'debilitar', 'Liche, Señor de los No-Muertos', 'Selló su alma en un objeto oculto para no morir jamás de verdad.', 'epico', true, { hp: 1826, atk: 328, def: 333, agi: 204, wis: 346 });
addBoss('magooscuro', 'rayo', 'brujo', 'debilitar', 'El Mago Oscuro sin Nombre', 'Su nombre se ha borrado del recuerdo — pero su sombra sigue creciendo.', 'epico', true, { hp: 1861, atk: 417, def: 205, agi: 159, wis: 348 });
addBoss('loki', 'rayo', 'brujo', 'debilitar', 'Loki, el Dios del Engaño', 'Nunca se sabe si su ayuda es un regalo o el inicio de una trampa.', 'epico', true, { hp: 1831, atk: 397, def: 276, agi: 228, wis: 358 });
addBoss('joker', 'viento', 'picaro', 'aturdir', 'El Bufón de la Locura', 'Nadie entiende su chiste hasta que ya es demasiado tarde para reírse.', 'epico', true, { hp: 1335, atk: 397, def: 137, agi: 231, wis: 73 });
addBoss('acromantula', 'tierra', 'picaro', 'aturdir', 'Acromántula, Madre de la Colonia', 'Donde hay una, hay cientos más esperando entre las sombras.', 'epico', true, { hp: 1425, atk: 422, def: 153, agi: 365, wis: 91 });
addBoss('wendigo', 'viento', 'brujo', 'furia', 'Wendigo, Hambre sin Fin', 'Cuanto más devora, más hambriento se vuelve — nunca se sacia.', 'epico', true, { hp: 1720, atk: 444, def: 267, agi: 143, wis: 309 });
addBoss('mantisreligiosa', 'viento', 'picaro', 'furia', 'Mantis, la Segadora Silenciosa', 'Espera inmóvil durante horas... y ataca en una fracción de segundo.', 'epico', true, { hp: 1097, atk: 479, def: 173, agi: 405, wis: 101 });
...
addBoss('guardianbosque', 'tierra', 'campeon', 'escudo', 'Guardián del Bosque Ancestral', 'Un espíritu milenario que protege cada árbol de la Linde del Bosque.', 'comun', true, { hp: 715, atk: 29, def: 14, agi: 44, wis: 31 });
addBoss('brujapantano', 'agua', 'brujo', 'ceguera', 'Bruja del Pantano Eterno', 'Conoce cada raíz y cada sombra del Pantano Oscuro, y las usa contra los intrusos.', 'infrecuente', true, { hp: 501, atk: 87, def: 74, agi: 54, wis: 86 });
addBoss('colosocristal', 'tierra', 'campeon', 'golpe', 'Coloso de Cristal', 'Sus puños de cuarzo han sepultado a más de un intruso en las Cuevas de Cristal.', 'raro', true, { hp: 704, atk: 72, def: 143, agi: 45, wis: 19 });
addBoss('titanhielo', 'agua', 'campeon', 'escudo', 'Titán de Hielo Eterno', 'Ni la escalada más dura prepara a nadie para enfrentarse a él en la cima de los Picos Helados.', 'raro', true, { hp: 1458, atk: 156, def: 175, agi: 53, wis: 37 });
addBoss('reyruinas', 'tierra', 'brujo', 'debilitar', 'Rey Espectral de las Ruinas', 'Gobierna las Ruinas Abisales desde un trono que se desmorona junto con su reino.', 'raro', true, { hp: 1659, atk: 304, def: 131, agi: 63, wis: 138 });
addBoss('dragonguarida', 'fuego', 'campeon', 'escudo', 'Dracorex, Señor de la Guarida', 'El dragón más temido de Texel, dueño absoluto de su Guarida.', 'epico', true, { hp: 2441, atk: 282, def: 237, agi: 58, wis: 40 });
...
setStatMult('sunwukong_legendario', { hp: 1.204371, atk: 1.204371, def: 1.204371, agi: 1.204371, wis: 1.204371 });
setStatMult('beowulf_legendario', { hp: 0.95271, atk: 0.95271, def: 0.95271, agi: 0.95271, wis: 0.95271 });
...
setStatMult('leviatan_legendario', { hp: 0.906399, atk: 0.906399, def: 0.906399, agi: 0.906399, wis: 0.906399 });
...
setStatMult('tyr_legendario', { hp: 0.9969, atk: 0.9969, def: 0.9969, agi: 0.9969, wis: 0.9969 });
...
setStatMult('miguelarcangel_legendario', { hp: 0.985771, atk: 0.985771, def: 0.985771, agi: 0.985771, wis: 0.985771 });
setStatMult('shango_legendario', { hp: 1.1005, atk: 1.1005, def: 1.1005, agi: 1.1005, wis: 1.1005 });
setStatMult('aquiles_legendario', { hp: 1.223075, atk: 1.223075, def: 1.223075, agi: 1.223075, wis: 1.223075 });
...
setStatMult('atenea_legendario', { hp: 1.110399, atk: 1.110399, def: 1.110399, agi: 1.110399, wis: 1.110399 });
...
setStatMult('sanson_legendario', { hp: 0.977018, atk: 0.977018, def: 0.977018, agi: 0.977018, wis: 0.977018 });
...
setStatMult('ragnar_legendario', { hp: 1.0105, atk: 1.0105, def: 1.0105, agi: 1.0105, wis: 1.0105 });
...
setStatMult('shinigami_legendario', { hp: 1.048348, atk: 1.048348, def: 1.048348, agi: 1.048348, wis: 1.048348 });
...
setStatMult('afrodita_legendario', { hp: 1.078, atk: 1.078, def: 1.078, agi: 1.078, wis: 1.078 });
...
addBoss('hades', 'tierra', 'brujo', 'debilitar', 'Hades, Señor del Inframundo', 'Gobierna el reino de los muertos con una justicia fría que ni los propios dioses se atreven a cuestionar.', 'legendario', true, { hp: 1750, atk: 418, def: 410, agi: 210, wis: 400 });
addBoss('hel', 'agua', 'brujo', 'maldicion', 'Hel, Soberana de los Muertos sin Honor', 'Mitad rostro de viva, mitad de cadáver, decide el destino de quienes no cayeron con gloria en la batalla.', 'legendario', true, { hp: 1700, atk: 402, def: 390, agi: 200, wis: 390 });
addBoss('set', 'tierra', 'brujo', 'sabotaje', 'Set, Señor de las Tormentas y el Caos', 'Asesinó a su propio hermano por el trono, y desde entonces el caos que siembra no conoce límites.', 'legendario', true, { hp: 1650, atk: 382, def: 355, agi: 200, wis: 345 });
addBoss('fafnir', 'fuego', 'campeon', 'golpe', 'Fafnir, el Dragón de la Avaricia', 'Su codicia por un tesoro maldito lo transformó en el dragón más temido de su época.', 'legendario', true, { hp: 1780, atk: 253, def: 420, agi: 110, wis: 70 });
addBoss('anzu', 'viento', 'brujo', 'aturdir', 'Anzu, el Ave-Demonio de la Tormenta', 'Robó la Tablilla de los Destinos a los propios dioses, y desde entonces el trueno le obedece.', 'legendario', true, { hp: 1350, atk: 324, def: 250, agi: 230, wis: 270 });
addBoss('simbionte', 'rayo', 'brujo', 'perforar', 'El Simbionte Devorador', 'Cayó de otro mundo y se fusionó con el primer cuerpo que encontró — ya no se sabe dónde termina la bestia y empieza su portador.', 'legendario', true, { hp: 1200, atk: 369, def: 270, agi: 250, wis: 260 });
addBoss('titancolosal', 'tierra', 'campeon', 'golpe', 'El Titán Colosal', 'Ninguna muralla construida por manos mortales ha resistido jamás su avance.', 'legendario', true, { hp: 3350, atk: 308, def: 650, agi: 140, wis: 90 });
...
addBoss('grendel', 'tierra', 'campeon', 'furia', 'Grendel, el Devorador de Salones', 'Ningún salón de guerreros, por bien custodiado que esté, ha sobrevivido intacto a una de sus visitas nocturnas.', 'legendario', true, { hp: 1580, atk: 198, def: 280, agi: 90, wis: 40 });
...
// de alrededor.
addBoss('jerseydevil', 'viento', 'brujo', 'debilitar', 'El Jersey Devil', 'Nadie que ha escuchado su chillido en mitad del bosque ha vuelto a dormir tranquilo.', 'legendario', true, { hp: 1210, atk: 334, def: 275, agi: 297, wis: 242 });
addBoss('gashadokuro', 'tierra', 'campeon', 'furia', 'Gashadokuro, Devorador de Caminantes', 'Formado por los huesos de miles de muertos olvidados, ningún caminante nocturno lo ve llegar hasta que ya es tarde.', 'legendario', true, { hp: 2000, atk: 280, def: 420, agi: 100, wis: 50 });
...
const ZONES = [
  ...
  { id: 'abismo_ojos', name: 'Abismo de los Cien Ojos', emoji: '👁️', color: '#1f2a3a', pool: ['gollum_epico', 'gigante_epico', 'boss_magooscuro'] },
  ...
  { id: 'minas_sinfondo', name: 'Minas Sin Fondo', emoji: '⛏️', color: '#3a1414', pool: ['gollum_epico', 'frankenstein_epico', 'boss_loki'] },
  { id: 'palacio_espejos', name: 'Palacio de Espejos', emoji: '🪞', color: '#3a2a4a', pool: ['dullahan_epico', 'hombreseisbrazos_epico', 'boss_rakshasa'] },
  { id: 'necropolis', name: 'Necrópolis Eterna', emoji: '💀', color: '#242424', pool: ['gollum_epico', 'banshee_epico', 'boss_liche'] },
  ...
  { id: 'llanura_huesos', name: 'Llanura de los Huesos Olvidados', emoji: '🌾', color: '#2a2620', pool: ['draugr_epico', 'banshee_epico', 'boss_gashadokuro'] },
...
const LEGENDARY_ITEMS = [
  ...
  // --- Tercera tanda (petición explícita: "mete al menos un objeto de
  // equipo legendario personalizado por cada familia de legendarios") —
  // las dos tandas anteriores solo cubrían 29 de las 65 familias
  // Legendario del juego; estos 36 objetos cubren TODAS las que faltaban
  // (incluidas las familias de monstruo genérico sin nombre propio —
  // ascua/nigro/lagarto/duende/chispa/piroman/brisa — que también son
  // Legendario aunque no sean figuras mitológicas). Con esto, cada una de
  // las 65 familias Legendario del roster tiene ya al menos un objeto
  // legendario personalizado propio.
  { id: 'escama_drakon', name: 'Escama de Drakón Ígneo', icon: '🐉', slot: 'armadura', targetFamily: 'ascua',
    primary: 'def', primaryMult: 1.2, secondary: 'hp', secondaryMult: 1.3,
    bg: 'linear-gradient(160deg, #3a1408, #d9481f 60%, #ffb380)',
    lore: 'Cada escama es más dura que la roca que la forjó — ningún golpe consigue atravesarla dos veces.' },
  { id: 'botas_maelstrom', name: 'Botas del Maelström', icon: '🌀', slot: 'botas', targetFamily: 'nigro',
    primary: 'agi', primaryMult: 1.15, secondary: 'wis', secondaryMult: 0.9,
    bg: 'linear-gradient(160deg, #06141f, #0f5c73 60%, #7fe0ea)',
    lore: 'Nada que cae dentro de su remolino vuelve a ver la superficie.' },
  { id: 'corona_obsidiana', name: 'Corona de Obsidiana', icon: '🗿', slot: 'casco', targetFamily: 'lagarto',
    primary: 'wis', primaryMult: 1.0, secondary: 'def', secondaryMult: 1.1,
    bg: 'linear-gradient(160deg, #0f0a14, #3a2a4a 60%, #9a7ab8)',
    lore: 'Ningún pico conocido ha logrado quebrar la piedra de esta corona.' },
  { id: 'guanteletes_torbellino', name: 'Guanteletes del Torbellino', icon: '🌪️', slot: 'guantes', targetFamily: 'duende',
    primary: 'atk', primaryMult: 1.25, secondary: 'agi', secondaryMult: 1.15,
    bg: 'linear-gradient(160deg, #123a1a, #4fae6a 60%, #e0ffe8)',
    lore: 'Arranca tornados capaces de arrasar un ejército con un solo golpe de sus puños.' },
  { id: 'corona_tormenta', name: 'Corona de la Tormenta', icon: '⛈️', slot: 'casco', targetFamily: 'chispa',
    primary: 'wis', primaryMult: 1.2, secondary: 'agi', secondaryMult: 0.8,
    bg: 'linear-gradient(160deg, #241a3a, #a24bd9 60%, #f5e34b)',
    lore: 'El cielo entero se dobla ante quien la lleva puesta.' },
  { id: 'manto_cenizas', name: 'Manto de Cenizas Eternas', icon: '⚱️', slot: 'armadura', targetFamily: 'piroman',
    primary: 'def', primaryMult: 1.0, secondary: 'wis', secondaryMult: 1.1,
    bg: 'linear-gradient(160deg, #1a1512, #5a3a2a 60%, #d97a3c)',
    lore: 'De sus cenizas nace un fuego que ningún viento logra apagar.' },
  { id: 'botas_vendaval', name: 'Botas del Vendaval', icon: '💨', slot: 'botas', targetFamily: 'brisa',
    primary: 'agi', primaryMult: 1.3, secondary: 'wis', secondaryMult: 0.7,
    bg: 'linear-gradient(160deg, #16321e, #5fbf7a 60%, #eaffea)',
    lore: 'Ningún viento de Texel sopla sin que estas botas lo permitan primero.' },
  { id: 'escama_hidra', name: 'Escama de la Hidra de Siete Cabezas', icon: '🐲', slot: 'armadura', targetFamily: 'hidradragon',
    primary: 'def', primaryMult: 1.15, secondary: 'atk', secondaryMult: 1.0,
    bg: 'linear-gradient(160deg, #241033, #6a2f9e 60%, #c89aff)',
    lore: 'Cada escama perteneció a una de sus siete cabezas — cortar una nunca fue suficiente.' },
  { id: 'pluma_fenix_legendaria', name: 'Pluma de Fénix Inmortal', icon: '🪶', slot: 'amuleto', targetFamily: 'avefenix',
    primary: 'wis', primaryMult: 1.1, secondary: 'hp', secondaryMult: 1.5,
    bg: 'linear-gradient(160deg, #3a1a0a, #e0722f 60%, #ffd699)',
    lore: 'Basta una sola pluma para renacer de las propias cenizas, brillando más que antes.' },
  { id: 'collar_cerbero', name: 'Collar de Cerbero', icon: '🦴', slot: 'amuleto', targetFamily: 'cerbero',
    primary: 'def', primaryMult: 1.2, secondary: 'hp', secondaryMult: 1.2,
    bg: 'linear-gradient(160deg, #140808, #5a1414 60%, #a83030)',
    lore: 'Ninguna alma, viva o muerta, pasa junto a su dueño sin su consentimiento.' },
  { id: 'ventosa_kraken', name: 'Ventosa del Kraken', icon: '🐙', slot: 'guantes', targetFamily: 'kraken',
    primary: 'atk', primaryMult: 1.2, secondary: 'def', secondaryMult: 0.9,
    bg: 'linear-gradient(160deg, #0a1a2e, #2f4a7a 60%, #7ac8ea)',
    lore: 'Se aferra a su presa con la misma fuerza con la que hunde flotas enteras.' },
  { id: 'escama_leviatan', name: 'Escama de Leviatán', icon: '🌊', slot: 'armadura', targetFamily: 'leviatan',
    primary: 'def', primaryMult: 1.3, secondary: 'hp', secondaryMult: 1.3,
    bg: 'linear-gradient(160deg, #08222a, #1f7a8a 60%, #a0ecec)',
    lore: 'Ningún capitán se atreve siquiera a nombrar la bestia que la llevó puesta primero.' },
  { id: 'perla_shenlong', name: 'Perla de Shenlong', icon: '🔮', slot: 'amuleto', targetFamily: 'shenlong',
    primary: 'wis', primaryMult: 1.2, secondary: 'atk', secondaryMult: 0.85,
    bg: 'linear-gradient(160deg, #10203a, #3f7ab0 60%, #dff0ff)',
    lore: 'Sin ella, ningún campo de Texel volvería a recibir la lluvia.' },
  { id: 'mascara_pazuzu', name: 'Máscara de Pazuzu', icon: '👺', slot: 'casco', targetFamily: 'pazuzu',
    primary: 'wis', primaryMult: 1.1, secondary: 'def', secondaryMult: 0.9,
    bg: 'linear-gradient(160deg, #14180f, #4a5c2f 60%, #a8c060)',
    lore: 'Ni el viento del sur se atreve a soplar sin el permiso de quien la lleva.' },
  { id: 'disco_ra', name: 'Disco Solar de Ra', icon: '☀️', slot: 'amuleto', targetFamily: 'ra',
    primary: 'wis', primaryMult: 1.25, secondary: 'atk', secondaryMult: 0.9,
    bg: 'linear-gradient(160deg, #2a2005, #f0b83c 60%, #fff8d0)',
    lore: 'Sin él cruzando el cielo, ningún día en Texel volvería a amanecer.' },
  { id: 'capa_dracula', name: 'Capa de Drácula', icon: '🦇', slot: 'armadura', targetFamily: 'dracula',
    primary: 'def', primaryMult: 0.95, secondary: 'atk', secondaryMult: 1.1,
    bg: 'linear-gradient(160deg, #0a0a0f, #3a0f18 60%, #8a1f30)',
    lore: 'Ningún amanecer alcanza a quien la lleva antes de que regrese a su castillo.' },
  { id: 'enigma_esfinge', name: 'Enigma de la Esfinge', icon: '❓', slot: 'amuleto', targetFamily: 'esfinge',
    primary: 'wis', primaryMult: 1.15, secondary: 'def', secondaryMult: 1.0,
    bg: 'linear-gradient(160deg, #2a2010, #b89050 60%, #f0dba0)',
    lore: 'Solo los más sabios de Texel se atreven a intentar resolver lo que guarda.' },
  { id: 'nucleo_tecno', name: 'Núcleo de la Armadura Tecno', icon: '⚙️', slot: 'armadura', targetFamily: 'armaduratecno',
    primary: 'def', primaryMult: 1.1, secondary: 'atk', secondaryMult: 1.0,
    bg: 'linear-gradient(160deg, #14181f, #3f6a8a 60%, #a0e0ff)',
    lore: 'Ya no hay distinción entre el piloto y la máquina: son un único titán.' },
  { id: 'lampara_genio', name: 'Lámpara del Genio', icon: '🪔', slot: 'amuleto', targetFamily: 'genio',
    primary: 'wis', primaryMult: 1.2, secondary: 'atk', secondaryMult: 1.0,
    bg: 'linear-gradient(160deg, #0f1a3a, #3a4fb0 60%, #ffd66a)',
    lore: 'Nadie recuerda ya el precio real de los deseos que concede — hasta que es demasiado tarde.' },
  { id: 'sandalias_afrodita', name: 'Sandalias de Afrodita', icon: '🐚', slot: 'botas', targetFamily: 'afrodita',
    primary: 'agi', primaryMult: 1.1, secondary: 'wis', secondaryMult: 1.1,
    bg: 'linear-gradient(160deg, #2a1020, #d96fa0 60%, #ffe0f0)',
    lore: 'Ningún corazón en Texel es inmune a quien las lleva puestas.' },
  { id: 'hacha_ragnar', name: 'Hacha de Ragnar Lothbrok', icon: '🪓', slot: 'arma', targetFamily: 'ragnar',
    primary: 'atk', primaryMult: 1.35, secondary: 'hp', secondaryMult: 1.2,
    bg: 'linear-gradient(160deg, #1a1510, #5a4530 60%, #c9a870)',
    lore: 'Ha conquistado tierras enteras más allá del mar sin más arma que esta.' },
  { id: 'colmillo_ganesha', name: 'Colmillo Roto de Ganesha', icon: '🐘', slot: 'guantes', targetFamily: 'ganesha',
    primary: 'wis', primaryMult: 1.0, secondary: 'hp', secondaryMult: 1.3,
    bg: 'linear-gradient(160deg, #2a1a08, #d97a2f 60%, #ffd699)',
    lore: 'Ningún comienzo en Texel se considera de buen augurio sin su bendición.' },
  { id: 'ajorca_kali', name: 'Ajorca de Kali', icon: '💀', slot: 'botas', targetFamily: 'kali',
    primary: 'agi', primaryMult: 1.0, secondary: 'atk', secondaryMult: 1.15,
    bg: 'linear-gradient(160deg, #0a0a0a, #4a0f18 60%, #a83050)',
    lore: 'Ante ella, hasta los ciclos del tiempo terminan.' },
  { id: 'sandalias_pele', name: 'Sandalias de Lava de Pele', icon: '🌋', slot: 'botas', targetFamily: 'pele',
    primary: 'agi', primaryMult: 1.0, secondary: 'wis', secondaryMult: 1.2,
    bg: 'linear-gradient(160deg, #140805, #d9451f 60%, #ff9955)',
    lore: 'El propio suelo de Texel obedece a quien las lleva puestas.' },
  { id: 'falda_coatlicue', name: 'Falda de Serpientes de Coatlicue', icon: '🐍', slot: 'armadura', targetFamily: 'coatlicue',
    primary: 'def', primaryMult: 1.1, secondary: 'wis', secondaryMult: 0.95,
    bg: 'linear-gradient(160deg, #14180a, #3f4a20 60%, #8a9a4a)',
    lore: 'Ante la madre de todo lo que nace y muere, el ciclo entero del mundo se inclina.' },
  { id: 'lanza_ares', name: 'Lanza de Ares', icon: '🗡️', slot: 'arma', targetFamily: 'ares',
    primary: 'atk', primaryMult: 1.4, secondary: 'def', secondaryMult: 1.0,
    bg: 'linear-gradient(160deg, #1a0a08, #8a1f1f 60%, #d95050)',
    lore: 'Ningún campo de batalla queda en calma mientras la lleve en la mano.' },
  { id: 'arco_artemisa', name: 'Arco de Plata de Artemisa', icon: '🏹', slot: 'arma', targetFamily: 'artemisa',
    primary: 'atk', primaryMult: 1.25, secondary: 'agi', secondaryMult: 1.15,
    bg: 'linear-gradient(160deg, #14202a, #6a8aa0 60%, #e8f0ff)',
    lore: 'Su flecha nunca conoce la piedad, ni de día ni bajo la luna.' },
  { id: 'garras_sekhmet', name: 'Garras de Sekhmet', icon: '🦁', slot: 'guantes', targetFamily: 'sekhmet',
    primary: 'atk', primaryMult: 1.3, secondary: 'hp', secondaryMult: 1.1,
    bg: 'linear-gradient(160deg, #2a1408, #c9682f 60%, #ffb380)',
    lore: 'Ningún enemigo de Texel sobrevive a la furia que desatan.' },
  { id: 'diente_sobek', name: 'Diente de Sobek', icon: '🐊', slot: 'guantes', targetFamily: 'sobek',
    primary: 'def', primaryMult: 1.0, secondary: 'atk', secondaryMult: 1.1,
    bg: 'linear-gradient(160deg, #0f1a10, #3f5a30 60%, #a0c070)',
    lore: 'Ninguna orilla de Texel está a salvo sin su vigilancia.' },
  { id: 'guantelete_hefesto', name: 'Guantelete de Hefesto', icon: '⚒️', slot: 'guantes', targetFamily: 'hefesto',
    primary: 'def', primaryMult: 1.15, secondary: 'atk', secondaryMult: 0.95,
    bg: 'linear-gradient(160deg, #1a1410, #6a4020 60%, #e08030)',
    lore: 'Ninguna armadura salida de estas manos ha fallado jamás.' },
  { id: 'espadas_musashi', name: 'Las Dos Espadas de Musashi', icon: '🗡️', slot: 'arma', targetFamily: 'musashi',
    primary: 'atk', primaryMult: 1.35, secondary: 'agi', secondaryMult: 1.05,
    bg: 'linear-gradient(160deg, #14181a, #5f6f7a 60%, #e0eaf0)',
    lore: 'Su estilo de dos espadas ya es leyenda en cada dojo de Texel.' },
  { id: 'alabarda_guanyu', name: 'Alabarda de Guan Yu', icon: '⚔️', slot: 'arma', targetFamily: 'guanyu',
    primary: 'atk', primaryMult: 1.3, secondary: 'def', secondaryMult: 1.1,
    bg: 'linear-gradient(160deg, #0a1a10, #2f7a4a 60%, #d4af37)',
    lore: 'Su lealtad y su fuerza lo elevaron a dios de la guerra.' },
  { id: 'espada_atila', name: 'Espada de Marte de Atila', icon: '⚔️', slot: 'arma', targetFamily: 'atila',
    primary: 'atk', primaryMult: 1.3, secondary: 'agi', secondaryMult: 1.0,
    bg: 'linear-gradient(160deg, #14100a, #6a1f1a 60%, #c94530)',
    lore: 'Se dice que donde pisa el caballo de quien la porta, la hierba no vuelve a crecer.' },
  { id: 'yelmo_khagan', name: 'Yelmo del Khagan', icon: '🪖', slot: 'casco', targetFamily: 'khagan',
    primary: 'def', primaryMult: 0.9, secondary: 'agi', secondaryMult: 1.2,
    bg: 'linear-gradient(160deg, #1a1610, #7a6a3a 60%, #e0c878)',
    lore: 'Ningún pueblo se atreve a alzar sus murallas sin temer la llegada de quien lo lleva.' },
  { id: 'guadana_shinigami', name: 'Guadaña del Shinigami', icon: '☠️', slot: 'arma', targetFamily: 'shinigami',
    primary: 'atk', primaryMult: 1.3, secondary: 'wis', secondaryMult: 1.05,
    bg: 'linear-gradient(160deg, #0a0a0a, #2a2a2a 60%, #8a8a8a)',
    lore: 'Ninguna alma escapa dos veces a quien la empuña.' },
  { id: 'yelmo_beowulf', name: 'Yelmo de Beowulf', icon: '🪖', slot: 'casco', targetFamily: 'beowulf',
    primary: 'def', primaryMult: 1.15, secondary: 'hp', secondaryMult: 1.2,
    bg: 'linear-gradient(160deg, #10202a, #3f6a8a 60%, #cfe0ec)',
    lore: 'Mató a Grendel con sus propias manos — este yelmo es lo único que llevó puesto ese día.' },
];
