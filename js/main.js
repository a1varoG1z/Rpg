...
(function () {
  ...
  $('rosterFilterFusion').addEventListener('change', (e) => { UI.rosterFilter.fusion = e.target.value; UI.renderBanda(state); });
  ...
  $('statsBtn').addEventListener('click', () => UI.openStats(state));
